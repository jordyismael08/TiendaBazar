    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h2>PEDIDOS <small class="tittles-pages-logo">B&P Jesymel</small></h2>
            </div>
            <br><br><br>
            <div class="row">
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <img class="img-responsive center-all-contens" src="assets/img/credit.png">
                            <p class="text-center">
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tipo-envio" data-toggle="tooltip" data-placement="top" title="Elige El Tipo De Envio">
                      ...
                      <option value="Envio Por Servientrega">Envio + Recargo</option> 
                  </select>
               </div>
                <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <p class="help-block"><small>Tipos de archivos permitido, imagenes .jpg y .png. Maximo 5 MB</small></p>
                    </div>
                <?php else: ?>
                    <div class="form-group">
                        <label>Numero de deposito</label>
