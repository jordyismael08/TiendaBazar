    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="./assets/img/tienda.png" alt="slider1" style="width: 100%; display: block; margin:  auto;">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/utiles.jpg" alt="slider2" style="width: 100%; display: block; margin:  auto;">
                <div class="carousel-caption">
                    
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/utiles1.jpg" alt="slider3" style="width: 100%; display: block; margin:  auto;">
                <div class="carousel-caption">
    ...
    <section id="new-prod-index">    
         <div class="container">
            <div class="page-header">
                <h2>Últimos <small>productos agregados</small></h2>
            </div>
            <div class="row">
              	<?php
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">B&P Jesymel</span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/utiles.jpg" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
